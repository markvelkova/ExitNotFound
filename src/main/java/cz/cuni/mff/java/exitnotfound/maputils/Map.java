...
import cz.cuni.mff.java.exitnotfound.maputils.factories.BadTileFactory;
import cz.cuni.mff.java.exitnotfound.maputils.factories.GoodTileFactory;
import cz.cuni.mff.java.exitnotfound.maputils.interfaces.*;
import cz.cuni.mff.java.exitnotfound.maputils.tiles.Wall;
import cz.cuni.mff.java.exitnotfound.maputils.topobjects.Apple;
import cz.cuni.mff.java.exitnotfound.maputils.topobjects.Door;
...
public class Map implements Serializable {
    /**
     * Configuration for tile generation and game difficulty settings.
     */
    private MapConfig config;
    /**
     * Factory for creating beneficial (good) map tiles with randomized effects.
     */
    private GoodTileFactory goodFact;
    /**
     * Factory for creating harmful (bad) map tiles with randomized effects.
     */
    private BadTileFactory badFact;
    /**
     * 2D array of map tiles representing the ground layer (excludes top objects).
     */
    private MapTile[][] mapWithoutTopObjects;
    /**
     * 2D array of top-level objects such as doors and apples.
     */
    private TopObject[][] mapOfTopObjects;
    /**
     * The height of the map in tiles (number of rows).
     */
    public final int height;
    /**
     * The width of the map in tiles (number of columns).
     */
    ...
    /**
     * Internal helper method to read and parse a single tile or object from map data.
     *
     * @param newChar the character code representing the tile or object
     * @param i the row index
     * @param j the column index
     * @return true if the player starting position was found, false otherwise
     */
    ...
    /**
     * Internal helper method to create a map tile based on the character code.
     *
     * @param c the character code representing the tile type
     * @return a new MapTile of the appropriate type
     */
    ...
    /**
     * Internal helper method to create a top object based on the character code.
     *
     * @param c the character code representing the object type
     * @return a new TopObject of the appropriate type, or null if unrecognized
     */
     ...
     * The display shows:
     * - Player position with facing direction {@code ^, v, <, >}
    ...
    public static class Coord implements Serializable{
        /**
         * The x coordinate (horizontal position on the map).
         */
        public final int x;
        /**
         * The y coordinate (vertical position on the map).
         */
        public final int y;
