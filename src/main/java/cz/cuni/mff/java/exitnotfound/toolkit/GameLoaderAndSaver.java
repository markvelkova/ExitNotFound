...
/**
 * Utility class for saving and loading complete game states to/from disk.
 *
 * This class provides methods for persisting game progress using Java serialization,
 * allowing players to save their game and resume later. The modern save/load methods
 * (save2/load2) serialize the entire GameState object, while legacy methods handle
 * simpler text-based formats.
 */
